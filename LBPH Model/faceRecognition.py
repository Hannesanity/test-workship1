...
def faceDetection(test_img):             
    ...
    face_haar=cv2.CascadeClassifier(r'C:\Users\Niels\Desktop\Programming\Initial Program\LBPH Model\haarcascade_frontalface_default.xml') #Give path to haar classifier as i have given
